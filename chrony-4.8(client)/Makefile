...
SYSCONFDIR = /opt/Chrony/etc
BINDIR = /opt/Chrony/bin
SBINDIR = /opt/Chrony/sbin
LOCALSTATEDIR = /opt/Chrony/var
CHRONYVARDIR = /opt/Chrony/var/lib
DESTDIR =
...
EXTRA_OBJS = sys_generic.o sys_linux.o sys_timex.o sys_posix.o cmdmon.o manual.o pktlength.o refclock.o refclock_phc.o refclock_pps.o     refclock_rtc.o refclock_shm.o refclock_sock.o hwclock.o ntp_io_linux.o rtc_linux.o cmac_nettle.o hash_nettle.o siv_nettle.o nts_ke_client.o nts_ke_server.o nts_ke_session.o tls_gnutls.o nts_ntp_auth.o nts_ntp_client.o nts_ntp_server.o
